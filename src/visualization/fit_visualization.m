...
contourspherefig('Watson',params,viewangles(1,:),0.5,target,'type1')
if save;exportgraphics(gcf,[folder,'figs/Watson_view1.png'],'resolution',300);end
contourspherefig('Watson',params,viewangles(2,:),0.5,target,'type1')
...
contourspherefig('ACG',params,viewangles(1,:),0.5,target,'type1')
...
contourspherefig('ACG',params,viewangles(2,:),0.5,target,'type1')
...
params.L = L;
% params.pi = pi;
contourspherefig('MACG',params,viewangles(1,:),0.5,target,'type1')
...
contourspherefig('MACG',params,viewangles(2,:),0.5,target,'type1')
