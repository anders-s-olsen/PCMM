    ...
    for tt in range(2): # train test likelihood
        ...
        for idx2,p in enumerate([3,10,25]):
            for idx1,K in enumerate([2,5,10]):
                ...
                if tt == 0:
                    axs[idx1,idx2].set_title(name+' 454-dimensional data training log-likelihood, p='+str(p)+' K='+str(K), fontsize=12)
                elif tt == 1:
                    axs[idx1,idx2].set_title(name+' 454-dimensional data test log-likelihood, p='+str(p)+' K='+str(K), fontsize=12)
