...
def run_experiment(extraoptions={},suppress_output=False):
    ...
    # load data using h5
    options['experiment_name'] = 'phase_amplitude_controlled_'+options['modelname']+'_initKmeansseg'
    with h5.File('data/synthetic/phase_amplitude_controlled_116data_eida.h5','r') as f:
    # options['experiment_name'] = 'phase_controlled_'+options['modelname']+'_initKmeansseg'
